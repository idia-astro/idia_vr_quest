 ...
 * @const
 */
proto.DataApi.ImageInfo.repeatedFields_ = [3];
...
proto.DataApi.ImageInfoRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    hdu: jspb.Message.getFieldWithDefault(msg, 3, "")
  };
...
/**
 * optional string hdu = 3;
 * @return {string}
 */
proto.DataApi.ImageInfoRequest.prototype.getHdu = function() {
 ...
 * @return {!proto.DataApi.ImageInfoRequest} returns this
 */
proto.DataApi.ImageInfoRequest.prototype.setHdu = function(value) {
